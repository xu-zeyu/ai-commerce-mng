...
export const Permissions = {
  ...
  SUPPLIER_BRAND_CREATE: "SUPPLIER_BRAND_CREATE",
  SUPPLIER_BRAND_PAGE: "SUPPLIER_BRAND_PAGE",
  SUPPLIER_BRAND_UPDATE: "SUPPLIER_BRAND_UPDATE",
  SUPPLIER_BRAND_DELETE: "SUPPLIER_BRAND_DELETE",
  PRODUCT_SPU_CREATE: "PRODUCT_SPU_CREATE",
  PRODUCT_SPU_PAGE: "PRODUCT_SPU_PAGE",
  PRODUCT_SPU_UPDATE: "PRODUCT_SPU_UPDATE",
  PRODUCT_SPU_DELETE: "PRODUCT_SPU_DELETE",
  PRODUCT_SPU_IMAGE_CREATE: "PRODUCT_SPU_IMAGE_CREATE",
  PRODUCT_SPU_IMAGE_PAGE: "PRODUCT_SPU_IMAGE_PAGE",
  PRODUCT_SPU_IMAGE_UPDATE: "PRODUCT_SPU_IMAGE_UPDATE",
  PRODUCT_SPU_IMAGE_DELETE: "PRODUCT_SPU_IMAGE_DELETE",
  PRODUCT_SKU_CREATE: "PRODUCT_SKU_CREATE",
  PRODUCT_SKU_PAGE: "PRODUCT_SKU_PAGE",
  PRODUCT_SKU_UPDATE: "PRODUCT_SKU_UPDATE",
  PRODUCT_SKU_DELETE: "PRODUCT_SKU_DELETE",
