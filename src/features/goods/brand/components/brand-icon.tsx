...
export function BrandIcon({ value, name, className }: Props) {
  ...
  if (!icon) {
    return (
      <span
        className={cn(
          'flex items-center justify-center rounded-2xl bg-secondary text-primary',
          className,
        )}
      >
  ...
  return (
    <span
      className={cn(
        'flex items-center justify-center rounded-2xl bg-secondary text-xl',
        className,
      )}
    >
      {icon}
