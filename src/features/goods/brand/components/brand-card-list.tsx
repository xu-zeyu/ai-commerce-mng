...
import { BRAND_DELETE_CODES, BRAND_UPDATE_CODES } from '../lib/brand-permissions'
...
export function BrandCardList({ brands, loading, onEdit, onDelete }: Props) {
  if (loading) {
    return (
